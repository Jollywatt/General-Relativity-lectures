...
The Lorentz group $\mathrm{O}(1,3)$ consists of (combinations of) the following:
\begin{itemize}
...
\end{itemize}
Both rotations and boosts depend on continuous parameters ($\theta$ or $\alpha$, respectively).
